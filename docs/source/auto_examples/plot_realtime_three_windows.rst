...
.. "auto_examples/plot_realtime_three_windows.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_plot_realtime_three_windows.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_realtime_three_windows.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 66-101
...
.. image-sg:: /auto_examples/images/sphx_glr_plot_realtime_three_windows_001.png
   :alt: Window 1 — Raw EEG signal (StreamViewer)
   :srcset: /auto_examples/images/sphx_glr_plot_realtime_three_windows_001.png
...
.. image-sg:: /auto_examples/images/sphx_glr_plot_realtime_three_windows_002.png
   :alt: Window 2 — NF signal monitor (NFSignalPlot)
   :srcset: /auto_examples/images/sphx_glr_plot_realtime_three_windows_002.png
   :class: sphx-glr-single-img
...
.. image-sg:: /auto_examples/images/sphx_glr_plot_realtime_three_windows_003.png
   :alt: Window 3 — Brain activation (BrainPlot), Alpha power (8–12 Hz) per electrode
   :srcset: /auto_examples/images/sphx_glr_plot_realtime_three_windows_003.png
   :class: sphx-glr-single-img
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_realtime_three_windows.ipynb <plot_realtime_three_windows.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_realtime_three_windows.py <plot_realtime_three_windows.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_realtime_three_windows.zip <plot_realtime_three_windows.zip>`
